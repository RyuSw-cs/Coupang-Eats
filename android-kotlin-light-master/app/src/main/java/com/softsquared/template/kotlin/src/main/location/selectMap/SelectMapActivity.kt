package com.softsquared.template.kotlin.src.main.location.selectMap
    ...
    fun init() {
        with(binding) {
            ...
            btApply.setOnClickListener {
                //데이터 전달, 주소상세로 이동
                val intent = Intent(this@SelectMapActivity, LocationAddActivity::class.java)
